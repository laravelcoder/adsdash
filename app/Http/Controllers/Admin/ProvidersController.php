...
class ProvidersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.providers.create', compact('created_bies', 'created_by_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.providers.edit', compact('provider', 'created_bies', 'created_by_teams'));
    }
    ...
    public function show($id)
    {
        ...
        $created_bies = \App\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');
        $created_by_teams = \App\Team::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');$stations = \App\Station::where('provider_id', $id)->get();$networks = \App\Network::whereHas('provider',
