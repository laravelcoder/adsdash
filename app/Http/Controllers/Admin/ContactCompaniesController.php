...
class ContactCompaniesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $contacts = \App\Contact::where('company_id', $id)->get();$audiences = \App\Audience::whereHas('companies',
        ...
        return view('admin.contact_companies.show', compact('contact_company', 'contacts', 'audiences'));
    }
