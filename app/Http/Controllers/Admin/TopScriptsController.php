...
class TopScriptsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.top_scripts.create', compact('pages'));
    }
    ...
    public function store(StoreTopScriptsRequest $request)
    {
        ...
        $top_script->pages()->sync(array_filter((array)$request->input('pages')));
    ...
    public function edit($id)
    {
        ...
        return view('admin.top_scripts.edit', compact('top_script', 'pages'));
    }
