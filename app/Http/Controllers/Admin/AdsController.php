...
class AdsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $created_bies = \App\User::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');$ad_types = \App\AdType::where('ad_id', $id)->get();

        $ad = Ad::findOrFail($id);

        return view('admin.ads.show', compact('ad', 'ad_types'));
    }
