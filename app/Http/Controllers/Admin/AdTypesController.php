...
class AdTypesController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $table->editColumn('ad.ad_type', function ($row) {
                return $row->ad ? $row->ad->ad_type : '';
            });
    ...
    public function create()
    {
        ...
        $ads = \App\Ad::get()->pluck('ad_type', 'id')->prepend(trans('global.app_please_select'), '');

        return view('admin.ad_types.create', compact('ads'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.ad_types.edit', compact('ad_type', 'ads'));
    }
