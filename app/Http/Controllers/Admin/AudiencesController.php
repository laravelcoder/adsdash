...
class AudiencesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.audiences.create', compact('created_bies', 'created_by_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.audiences.edit', compact('audience', 'created_bies', 'created_by_teams'));
    }
