...
class DemographicsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (! Gate::allows('demographic_delete')) {
            ...
            $table->editColumn('audience.name', function ($row) {
                return $row->audience ? $row->audience->name : '';
            });
    ...
    public function create()
    {
        ...
        $audiences = \App\Audience::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');

        return view('admin.demographics.create', compact('audiences'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.demographics.edit', compact('demographic', 'audiences'));
    }
