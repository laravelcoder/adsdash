...
class DemographicsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.demographics.create', compact('created_bies', 'created_by_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.demographics.edit', compact('demographic', 'created_bies', 'created_by_teams'));
    }
