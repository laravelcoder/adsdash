...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $user_bases = \App\UserBase::where('created_by_team_id', $id)->get();$audiences = \App\Audience::where('created_by_team_id', $id)->get();$demographics = \App\Demographic::where('created_by_team_id', $id)->get();$users = \App\User::where('team_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'user_bases', 'audiences', 'demographics', 'users'));
    }
