...
class TeamsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $providers = \App\Provider::where('created_by_team_id', $id)->get();$clipdbs = \App\Clipdb::where('created_by_team_id', $id)->get();$user_bases = \App\UserBase::where('created_by_team_id', $id)->get();$bottom_scripts = \App\BottomScript::where('created_by_team_id', $id)->get();$users = \App\User::where('team_id', $id)->get();$contacts = \App\Contact::where('created_by_team_id', $id)->get();$agents = \App\Agent::where('created_by_team_id', $id)->get();

        $team = Team::findOrFail($id);

        return view('admin.teams.show', compact('team', 'providers', 'clipdbs', 'user_bases', 'bottom_scripts', 'users', 'contacts', 'agents'));
    }
