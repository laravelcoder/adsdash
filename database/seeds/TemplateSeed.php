...
class TemplateSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 1, 'template_name' => 'dash', 'layout' => '        <div class="row">
          <div class="col-md-12">
            <div class="card">
          ...
          <!-- /.col -->
            ...
            ['id' => 2, 'template_name' => 'TEST TEMPLATE', 'layout' => '        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Monthly Recap Report</h5>
          ...
          <!-- /.col -->
        </div>', 'description' => 'TEST TEMPLATE TO MAKE SURE NEW TEMPLATE BUILDER IS WORKING',],
