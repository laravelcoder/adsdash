...
class Add5b060671128b5RelationshipsToAssetsHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('assets_histories', function(Blueprint $table) {
            if(Schema::hasColumn('assets_histories', 'asset_id')) {
                $table->dropForeign('163041_5b0600d3d52bb');
                $table->dropIndex('163041_5b0600d3d52bb');
                $table->dropColumn('asset_id');
            }
            if(Schema::hasColumn('assets_histories', 'status_id')) {
                $table->dropForeign('163041_5b0600d3e4dc5');
                $table->dropIndex('163041_5b0600d3e4dc5');
                $table->dropColumn('status_id');
            }
            if(Schema::hasColumn('assets_histories', 'location_id')) {
                $table->dropForeign('163041_5b0600d4032e7');
                $table->dropIndex('163041_5b0600d4032e7');
                $table->dropColumn('location_id');
            }
            if(Schema::hasColumn('assets_histories', 'assigned_user_id')) {
                $table->dropForeign('163041_5b0600d416ca3');
                $table->dropIndex('163041_5b0600d416ca3');
