...
class Add5b0de13f90546RelationshipsToAgentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('agents', function(Blueprint $table) {
            if (!Schema::hasColumn('agents', 'company_id')) {
                ...
                $table->foreign('created_by_id', '164212_5b08676ce1827')->references('id')->on('users')->onDelete('cascade');
                }
