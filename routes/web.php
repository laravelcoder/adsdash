...
Route::group(['middleware' => ['auth', 'approved'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('network_dashboards', 'Admin\NetworkDashboardsController');
    ...
    Route::resource('stylesheets', 'Admin\StylesheetsController');
    Route::post('stylesheets_mass_destroy', ['uses' => 'Admin\StylesheetsController@massDestroy', 'as' => 'stylesheets.mass_destroy']);
    Route::post('stylesheets_restore/{id}', ['uses' => 'Admin\StylesheetsController@restore', 'as' => 'stylesheets.restore']);
    Route::delete('stylesheets_perma_del/{id}', ['uses' => 'Admin\StylesheetsController@perma_del', 'as' => 'stylesheets.perma_del']);
    Route::resource('top_scripts', 'Admin\TopScriptsController');
    Route::post('top_scripts_mass_destroy', ['uses' => 'Admin\TopScriptsController@massDestroy', 'as' => 'top_scripts.mass_destroy']);
    Route::post('top_scripts_restore/{id}', ['uses' => 'Admin\TopScriptsController@restore', 'as' => 'top_scripts.restore']);
    Route::delete('top_scripts_perma_del/{id}', ['uses' => 'Admin\TopScriptsController@perma_del', 'as' => 'top_scripts.perma_del']);
    Route::resource('bottom_scripts', 'Admin\BottomScriptsController');
    Route::post('bottom_scripts_mass_destroy', ['uses' => 'Admin\BottomScriptsController@massDestroy', 'as' => 'bottom_scripts.mass_destroy']);
    Route::post('bottom_scripts_restore/{id}', ['uses' => 'Admin\BottomScriptsController@restore', 'as' => 'bottom_scripts.restore']);
    Route::delete('bottom_scripts_perma_del/{id}', ['uses' => 'Admin\BottomScriptsController@perma_del', 'as' => 'bottom_scripts.perma_del']);
    Route::resource('layouts', 'Admin\LayoutsController');
    Route::post('layouts_mass_destroy', ['uses' => 'Admin\LayoutsController@massDestroy', 'as' => 'layouts.mass_destroy']);
    Route::post('layouts_restore/{id}', ['uses' => 'Admin\LayoutsController@restore', 'as' => 'layouts.restore']);
    Route::delete('layouts_perma_del/{id}', ['uses' => 'Admin\LayoutsController@perma_del', 'as' => 'layouts.perma_del']);
    ...
    Route::resource('clipdbs', 'Admin\ClipdbsController');
    Route::post('clipdbs_mass_destroy', ['uses' => 'Admin\ClipdbsController@massDestroy', 'as' => 'clipdbs.mass_destroy']);
    Route::post('clipdbs_restore/{id}', ['uses' => 'Admin\ClipdbsController@restore', 'as' => 'clipdbs.restore']);
    Route::delete('clipdbs_perma_del/{id}', ['uses' => 'Admin\ClipdbsController@perma_del', 'as' => 'clipdbs.perma_del']);
    ...
    Route::resource('ad_responses', 'Admin\AdResponsesController');
    Route::post('ad_responses_mass_destroy', ['uses' => 'Admin\AdResponsesController@massDestroy', 'as' => 'ad_responses.mass_destroy']);
    Route::post('ad_responses_restore/{id}', ['uses' => 'Admin\AdResponsesController@restore', 'as' => 'ad_responses.restore']);
    Route::delete('ad_responses_perma_del/{id}', ['uses' => 'Admin\AdResponsesController@perma_del', 'as' => 'ad_responses.perma_del']);
