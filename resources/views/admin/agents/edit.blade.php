...
@section('content')
    ...
    {!! Form::model($agent, ['method' => 'PUT', 'route' => ['admin.agents.update', $agent->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('company_id', trans('global.agents.fields.company').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('last_name', trans('global.agents.fields.last-name').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('email', trans('global.agents.fields.email').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('skype', trans('global.agents.fields.skype').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('address', trans('global.agents.fields.address').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($agent->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$agent->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$agent->photo) }}"></a>
                    @endif
                    {!! Form::label('photo', trans('global.agents.fields.photo').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('about', trans('global.agents.fields.about').'', ['class' => 'control-label']) !!}
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody id="phones">
                    @forelse(old('phones', []) as $index => $data)
                        @include('admin.agents.phones_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($agent->phones as $item)
                            @include('admin.agents.phones_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
