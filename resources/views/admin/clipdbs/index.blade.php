            ...
            <table class="table table-bordered table-striped ajaxTable @can('clipdb_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        ...
                        <th>@lang('global.clipdb.fields.ad')</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [@can('clipdb_delete')
                ...
                @endif
                @endcan{data: 'ad.ad_label', name: 'ad.ad_label'},
                {data: 'ad.ad_description', name: 'ad.ad_description'},
                {data: 'clip_label', name: 'clip_label'},
                {data: 'link_to_clip', name: 'link_to_clip'},
