...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.templates.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('pages[]', $pages, old('pages'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-pages' ]) !!}
                    <p class="help-block"></p>
                    @if($errors->has('pages'))
                        <p class="help-block">
                            {{ $errors->first('pages') }}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="stylesheet">
                    @foreach(old('stylesheets', []) as $index => $data)
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="layouts">
                    @foreach(old('layouts', []) as $index => $data)
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="top-scripts">
                    @foreach(old('top_scripts', []) as $index => $data)
