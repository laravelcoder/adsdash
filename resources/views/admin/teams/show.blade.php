...
<li role="presentation" class="active"><a href="#user_base" aria-controls="user_base" role="tab" data-toggle="tab">User Base</a></li>
...
<div role="tabpanel" class="tab-pane active" id="user_base">
