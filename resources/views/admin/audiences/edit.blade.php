...
@section('content')
    ...
    {!! Form::model($audience, ['method' => 'PUT', 'route' => ['admin.audiences.update', $audience->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('companies[]', $companies, old('companies') ? old('companies') : $audience->companies->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-companies' ]) !!}
                    <p class="help-block"></p>
