...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('audience_id', trans('global.demographics.fields.audience').'', ['class' => 'control-label']) !!}
                    {!! Form::select('audience_id', $audiences, old('audience_id'), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('audience_id'))
                        <p class="help-block">
                            {{ $errors->first('audience_id') }}
                        </p>
                    @endif
                </div>
            </div>
